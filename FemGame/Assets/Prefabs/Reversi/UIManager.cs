...
public class UIManager : MonoBehaviour
{
    ...
    public void SetPlayerText(PlayerReversi currentPlayer)
    {
        ...
        {
            topText.text = "¬аша очередь <sprite name=DiscBlackUp>";
        }
        else if (currentPlayer == PlayerReversi.White)
        {
            topText.text = "ќчередь Ёммы <sprite name=DiscWhiteUp>";
        }
    }
    ...
    public void SetSkippedText(PlayerReversi skippedPlayer)
    {
        ...
        {
            topText.text = "¬ам некуда сходить! <sprite name=DiscBlackUp>";
        }
        else if (skippedPlayer == PlayerReversi.White)
        {
            topText.text = "Ёмме некуда сходить! <sprite name=DiscWhiteUp>";
        }
    }
    ...
    public void SetWinnerText(PlayerReversi winner)
    {
        switch (winner)
        {
            case PlayerReversi.Black:
                winnerText.text = "¬ы победили!";
                break;
            case PlayerReversi.White:
                winnerText.text = "Ёмма победила!";
                break;
            case PlayerReversi.None:
                winnerText.text = "Ќичь€!";
                break;
        }
    }
